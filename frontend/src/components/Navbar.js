            ...
            <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between relative">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <div className="flex items-center gap-2">
                        ...
                        <Link href="/calendar" className={router.pathname === '/calendar' ? 'nav-link-active' : 'nav-link'}>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link href="/notes" className={router.pathname === '/notes' ? 'nav-link-active' : 'nav-link'}>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <Link href="https://terry-development.github.io/Photo/" className={router.pathname === '/notes' ? 'nav-link-active' : 'nav-link'}>
                            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            Photo Watermark
                    ...
                    <div className="p-6 flex flex-col h-full">
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <Link
                                href="/calendar"
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-3 text-lg font-medium ${router.pathname === '/calendar' ? 'text-primary' : 'text-gray-300'}`}
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            ...
                            <Link
                                href="/notes"
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-3 text-lg font-medium ${router.pathname === '/notes' ? 'text-primary' : 'text-gray-300'}`}
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                </svg>
                            ...
                            <Link
                                href="https://terry-development.github.io/Photo/"
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-3 text-lg font-medium ${router.pathname === '/notes' ? 'text-primary' : 'text-gray-300'}`}
                            >
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
